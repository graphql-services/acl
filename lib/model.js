    ...
    constructor(resource) {
        this.isMatch = (resource, strict = true) => {
            ...
            if (strict) {
                ...
                if (this.paths.length > resourcePaths.length &&
...
class PermissionRule {
    constructor(rule) {
        this.isMatch = (resource, strict = false) => {
...
class PermissionList {
    constructor(permissions) {
        this.rules = [];
        this.isAllowed = (resource, strict = false) => {
            let allowed = false;
        ...
        this.getMatchingRules = (resource, strict = false) => {
            let result = [];
