...
class PermissionRule {
    constructor(rule) {
        ...
        this.getAttributes = (resource) => {
            return (this.resource.isMatch(resource) && this.resource.getAttributes(resource));
        };
...
class PermissionList {
    constructor(permissions) {
        ...
        this.getAttributes = (resource) => {
            ...
            return results.reduce((prev, x) => deepmerge_1.default(prev, x), {});
        };
